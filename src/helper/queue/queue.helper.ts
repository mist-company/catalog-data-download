...
import { CATALOG_DOWNLOAD_QUEUE_NAME, REDIS_URL } from "../../config";
import type { LoggerHelper } from "../logger/logger.helper";
import { inject, injectable } from "tsyringe";
import { BaseLoggerHelper } from "../logger/base-logger.helper";
import type { BaseQueueHelper } from "./base-queue.helper";
...
export class QueueHelper implements BaseQueueHelper {
	...
	constructor(@inject(BaseLoggerHelper) logger: LoggerHelper) {
		this.#queue = new Queue(CATALOG_DOWNLOAD_QUEUE_NAME, {
